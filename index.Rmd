...
### [Clustering] The clustering of 'singing in the shower' playlists and pop playlists reveal comparable cluster patterns.
...
The hierarchical clusterings are computed based on Euclidean distances. 
...
I don't believe the direct results of this project have many benefits, but I do think that the consideration of what makes a specific Spotify playlist distinct/unique could benefit research projects focusing on Spotify (or even other) playlists. 
